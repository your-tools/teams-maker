...
#[test]
fn test_compute_team_size_when_divisible() {
    assert_eq!(compute_team_sizes(16, 4), vec![4, 4, 4, 4]);
}

#[test]
fn test_compute_team_size_when_one_less() {
    assert_eq!(compute_team_sizes(15, 4), vec![4, 4, 4, 3]);
}

#[test]
fn test_compute_team_size_when_one_more() {
    assert_eq!(compute_team_sizes(17, 4), vec![4, 4, 4, 5]);
}

#[test]
fn test_compute_team_size_adjusting_two() {
